...
# Title: Robot
# Generated: Tue Jun 19 17:17:31 2018
##################################################
...
class robot(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.cons(pmt.make_dict(), pmt.make_u8vector(4,1)), 100)
...
def main(top_block_cls=robot, options=None):
