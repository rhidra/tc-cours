...
# Title: Message
# Generated: Fri Jun 15 12:58:05 2018
##################################################
...
class message(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msg_connect((self.blocks_tagged_stream_to_pdu_0_0, 'pdus'), (self.blocks_message_debug_1, 'print'))    
        self.msg_connect((self.pir_get_timestamp_delta_cm_0, 'out'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))    
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_throttle_0, 0))    
        self.connect((self.blocks_pdu_to_tagged_stream_0, 0), (self.blocks_tagged_stream_to_pdu_0_0, 0))    
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.digital_constellation_decoder_cb_1, 0))    
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.qtgui_time_sink_x_0, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.pir_get_timestamp_delta_cm_0, 0))    
