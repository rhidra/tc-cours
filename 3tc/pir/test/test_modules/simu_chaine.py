...
# Title: Simu Chaine
# Generated: Mon Jun 18 10:35:51 2018
##################################################
...
class simu_chaine(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, "/home/rhidra/pir/test/test_modules/out.txt", False)
        ...
        self.connect((self.analog_random_source_x_0, 0), (self.digital_crc32_bb_0_0, 0))    
        self.connect((self.analog_random_source_x_0, 0), (self.pir_print_bytes_bb_0, 0))    
        ...
        self.connect((self.blocks_tag_gate_0, 0), (self.qtgui_time_sink_x_2, 0))    
        ...
        self.connect((self.digital_crc32_bb_0, 0), (self.blocks_null_sink_1, 0))    
...
def main(top_block_cls=simu_chaine, options=None):
